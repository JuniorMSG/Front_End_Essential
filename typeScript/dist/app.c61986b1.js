...
"use strict"; // TypeScript는 트랜스파일러 
// 브라우저에서 실행시키려면 자바스크립트로 변환 시켜야 된다 (컴파일) 
// 프리미티브 타입 Boolean, 
// 객체 타입 (엄청 많음)
...
function getData(url) {
  ...
  ajax.send(); // 제네릭 Generic 유연하고 유용한 기능이지만 
  // 난이도가 상황에 따라 한도 끝도 없이 올라갈 수 있는 문법요소..
  // getData는 2개의 리턴값을 가지고 있는데 호출하는 입장에선 뭐가 올지 모름
  // Generic은 입력이 N개의 유형일 때 출력도 N개의 유형인 것을 정의하는것.
  // A => A' , B => B'
...
router();
},{}],"../../../Users/MSG/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12883" + '/');
...
},{}]},{},["../../../Users/MSG/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
